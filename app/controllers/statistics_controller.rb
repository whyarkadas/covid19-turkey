class StatisticsController < ApplicationController
  ...
  private
    ...
    def statistic_params
      params.require(:statistic).permit(:date, :total_infected, :daily_infected, :total_died, :daily_died, :intubated, :intensive_care, :total_test, :daily_test, :total_recovered, :daily_recovered)
    end
end
